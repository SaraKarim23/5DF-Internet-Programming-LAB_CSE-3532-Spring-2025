...
<body>
    <div class="container-fluid vh-100 d-flex align-items-center justify-content-center">
        <div class="row w-100">
            <!-- Left Section -->
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center px-5 animate__animated animate__fadeInLeft">
                <!-- Navbar with Logo -->
                <a class="navbar-brand" href="#">
                    <img src="images/BlessedHandslogo.png" alt="Blessed Hands Logo">
                    <span class="blessed-hands-text">Blessed Hands</span>
                </a>

                <!-- Navigation Tabs -->
                <ul class="nav nav-tabs mb-3 animate__animated animate__fadeInUp" id="loginTab" role="tablist">
                        ...
                        <div class="form-section">
                            <form action="login_data.php" method="POST">
                                ...
                                <button type="button" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center">
                                    <img src="https://img.icons8.com/color/48/google-logo.png" alt="Google Logo" style="width: 20px;"> Continue with Google
                                </button>
            ...
            <!-- Right Section -->
            <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center right-section animate__animated animate__fadeInRight">
                <div class="text-center">
                    <h3 class="animate__animated animate__zoomIn">We Make Giving Easy</h3>
                    <img src="images/signlogo.png" alt="Illustration" class="animate__animated animate__fadeInUp">
                </div>
            </div>
        </div>
    </div>
