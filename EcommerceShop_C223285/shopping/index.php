...
<html lang="en">
	<head>
	    ...
	    <title>ShopEase Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over BDT. 999.00</h6>	
				</div>
			</div><!-- .col -->
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">BDT.<?php echo htmlentities($row['productPrice']);?></span>
										     <span class="price-before-discount">RsBDT.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
