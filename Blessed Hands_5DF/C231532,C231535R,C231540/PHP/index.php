        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="register.php" class="btn btn-primary text-white">Sign Up</a>
                    </li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="campaign-card animate__animated animate__fadeInUp" style="padding: 10px; background-color: white; border: 1px solid #ddd; border-radius: 10px;">
                        ...
                        <h2 style="color: rgb(43, 35, 32); font-size: 1rem;">Children in Gaza need life-saving support</h2>
                        <p><strong>Raised:</strong> <span class="text-success">Tk 15,00,000.00</span></p>
                ...
                <div class="carousel-item">
                    <div class="campaign-card animate__animated animate__fadeInUp" style="padding: 10px; background-color: white; border: 1px solid #ddd; border-radius: 10px;">
                        ...
                        <p><strong>Raised:</strong> <span class="text-success">Tk 10,00,000.00</span></p>
